...
from backend.functions.channel_functions import channels_create, channels_listall, \
    channels_list, channel_leave, channel_join, channel_addowner, channel_removeowner, \
    channel_invite, channel_details, channel_messages
from backend.functions.message_functions import message_sendlater, message_send, \
    message_remove, message_edit, message_react, message_unreact, message_pin, \
    message_unpin
from backend.functions.profile_functions import user_profile_setemail, \
    user_profile_setname, user_profile_sethandle, user_profile_uploadphoto, \
    user_profile, user_listall
from backend.functions.misc_functions import search, admin_userpermission_change, \
    standup_start, standup_send, standup_active
...
def reset_request():
    ...
    try:
        msg = Message("Reset Code", sender="masterbranch101@gmail.com", recipients=[email])
